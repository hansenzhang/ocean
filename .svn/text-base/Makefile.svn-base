...
#
CXX	 = g++
CXXFLAGS = -MMD -ggdb -O3 -std=gnu++11 -m$(BITS) -I/proj/spear1/tbb41_20130613oss/include -L/proj/spear1/tbb41_20130613oss/lib -ltbb -fcilkplus -msse2 -ffast-math
LDFLAGS	 = -m$(BITS) -I/proj/spear1/tbb41_20130613oss/include -L/proj/spear1/tbb41_20130613oss/lib/intel64/gcc4.4 -lrt -ltbb
